; Attempts to determine if the scraplauncher is on cooldown.
; If so, perform a weapon swap, as the reload is faster
; than waiting for that cooldown.
;
; Requires positioning a window on the scraplauncher icon in order to support multiple resolutions...
;
; (I can't remember if this script also reactivates crowdfunder when switching, if found)
; (It may)
